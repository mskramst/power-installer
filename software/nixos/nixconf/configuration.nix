...
{ imports =
  ...
  users.users.techteam = { isNormalUser = true; description = "techteam"; extraGroups = [ "networkmanager" "wheel" 
    ]; packages = with pkgs; [
      firefox
    #  thunderbird
    ];
...
#     backgrounds
  ...
  # This value determines the NixOS release from which the default settings for stateful data, like file locations 
  # and database versions on your system were taken. It‘s perfectly fine and recommended to leave this value at 
  # the release version of the first install of this system. Before changing this value read the documentation for 
